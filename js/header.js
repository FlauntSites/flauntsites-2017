var stripeA = document.querySelector('#a'),
    stripeB = document.querySelector('#b'),
    stripeC = document.querySelector('#c');
...
function headerStripesSet() {

    var tl = new TimelineMax();
    tl.set([stripeA, stripeB, stripeC], { marginLeft: 0 });
...
/**
* If nothing has been stored in Session Storage,
* the long animation will play. If there is a value for 
* 'logo', the short animation will play.
*
*/

if (sessionStorage.getItem('fsStripes') != null) {
...
/**
* Set Session Storage to determine if the long logo animation
* or the short logo animation should be displayed.
*
*/

// sessionStorage.setItem( 'fsStripes', '1234' );
...
const chatPopout = function () {
    ...
    const chatContainer = document.querySelector('#tawkchat-status-icon')
