...
const chatPopout = function () {
    ...
    const tl = new TimelineMax;
    tl.to(chatMessage, .5, { autoAlpha: 1, width: 350, height: 57 }, 15)
        .to(chatMessage, .5, { autoAlpha: 0, width: 0, height: 0 }, '+=3')
...
const lightning = function () {
    ...
    identities.forEach(function (el) {
        ...
        tl.fromTo(highlightOne, .5, { autoAlpha: 0, drawSVG: "0% 80%" }, { autoAlpha: 1, drawSVG: "100% 100%", ease: Power4.easeIn })
            .fromTo(highlightTwo, .5, { autoAlpha: 0, drawSVG: "0% 80%" }, { autoAlpha: 1, drawSVG: "100% 100%", ease: Power4.easeIn }, '-=.6')
